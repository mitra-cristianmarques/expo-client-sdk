...
class EnrollmentProcessor(sessionToken: String?, context: Context) : Processor(),
    ...
    override fun processSessionWhileFaceTecSDKWaits(
        ...
        if (sessionResult.getStatus() != FaceTecSessionStatus.SESSION_COMPLETED_SUCCESSFULLY) {
            Log.d(
                "FaceTecSDKSampleApp",
                "Session was not completed successfully, cancelling. Session Status: " + sessionResult.getStatus()
            )
