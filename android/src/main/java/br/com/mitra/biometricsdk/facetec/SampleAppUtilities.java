...
public class SampleAppUtilities {
    ...
    static SampleAppUtilities.VocalGuidanceMode vocalGuidanceMode = VocalGuidanceMode.OFF;

    private SampleAppActivity sampleAppActivity;
    public String currentTheme = "Mitra";
    ...
    public void showAuditTrailImages() {
        ...
        if(sampleAppActivity.latestIDScanResult != null && !sampleAppActivity.latestIDScanResult.getBackImagesCompressedBase64().isEmpty()) {
            byte[] decodedString = Base64.decode(sampleAppActivity.latestIDScanResult.getBackImagesCompressedBase64().get(0), Base64.DEFAULT);
            Bitmap backImage = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
