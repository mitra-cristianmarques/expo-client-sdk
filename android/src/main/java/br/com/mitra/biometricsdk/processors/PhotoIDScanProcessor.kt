...
class PhotoIDScanProcessor(sessionToken: String?, context: Context) : Processor(),
    ...
    override fun processIDScanWhileFaceTecSDKWaits(
        ...
        try {
            ...
            if (frontImagesCompressedBase64.size > 0) {
                ...
                SampleAppActivity.Companion.documentFrontScan = frontImagesCompressedBase64.get(0)

                val parametersString = parameters.toString()
                SampleAppActivity.Companion.resquestFrontDocument = parametersString
            }
