...
public class VerificationProcessor extends Processor implements FaceTecFaceScanProcessor {
    private boolean success = false;
    private final SampleAppActivity sampleAppActivity;

    public VerificationProcessor(String sessionToken, Context context) {
        ...
        //
        FaceTecSessionActivity.createAndLaunchSession(context, VerificationProcessor.this, sessionToken);
    }
            ...
            public void onResponse(@NonNull Call call, @NonNull okhttp3.Response response) throws IOException {
                ...
                try {
                    ...
                    if(wasProcessed) {
                        ...
                        JSONObject faceScanSecurityChecks = responseJSON.getJSONObject("faceScanSecurityChecks");
                        boolean faceScanLivenessCheckSucceeded = faceScanSecurityChecks.getBoolean("faceScanLivenessCheckSucceeded");
